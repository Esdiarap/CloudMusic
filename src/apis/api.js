...
//获取歌曲信息
export const getSongInfoAPI = (params) => request.get(`song/detail?ids=${params.id}`);
//获取热门评论
...
//获取歌单 ( 网友精选碟 ) 111
export const getSongListAPI = (params) => request.get(`top/playlist?limit=${params.limit}&offset=${params.offset}`);
// 获取MV评论
export const getcommentMV = (params) => request.get(`/comment/mv?id=${params.id}&limit=${params.limit}&offset=${params.offset}`)
//推荐新音乐 222
export const getNewMusicAPI = () => request.get(`/personalized/newsong`);
// 最新mv
